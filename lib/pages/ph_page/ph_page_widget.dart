...
import 'ph_page_model.dart';
export 'ph_page_model.dart';

class PhPageWidget extends StatefulWidget {
  const PhPageWidget({super.key});

  @override
  State<PhPageWidget> createState() => _PhPageWidgetState();
}

class _PhPageWidgetState extends State<PhPageWidget> {
  late PhPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhPageModel());
  }
                              ...
                              Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    columnSensorsfullRecord?.ph.toString(),
                                    '7.2',
                                  ),
